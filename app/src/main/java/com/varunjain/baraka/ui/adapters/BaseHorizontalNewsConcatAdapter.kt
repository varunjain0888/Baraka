 ...
 */
class BaseHorizontalNewsConcatAdapter(private val context: Context,
                                      private val topNewsAdapter: TopTrendingNewsAdapter) :
    ...
    inner class ConcatViewHolder(itemView: View): BaseConcatHolder<TopTrendingNewsAdapter>(itemView){
        override fun bind(adapter: TopTrendingNewsAdapter) {
